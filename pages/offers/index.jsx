      ...
      if ("geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(
          function (position) {
            ...
            axios
              .get("/api/offers", { params: { userName, latitude, longitude } })
              .then((res) => {
              ...
              .catch((e) => {
                setGeoLocationError(
                  "Sorry we do not have any promotional offers in your city."
                );
              });
          },
          function (error) {
                  ...
                  {Object.keys(offers).map((offer) => (
                    <div id={offer} key={offer} className="offer">
                      <img
                        style={{ height: "150px" }}
                        alt={offer}
                        src={require(`../../public/static/${offers[offer].imageId}`)}
                      />
