...
const Orders = ({}) => {
  ...
  useEffect(() => {
    if (!userName) {
      ...
      axios
        .get("/api/orders", { params: { userName } })
        .then((res) => {
            ...
            {orders.length === 0 ? (
              ...
              orders.map((order) => (
                <div
                  id={order.id}
                  key={order.id}
                  className="a-box-group a-spacing-base order"
                >
                  ...
                  <div className="a-box shipment shipment-is-delivered">
                    <div className="a-box-inner">
                      ...
                      <div
                        className="a-fixed-right-grid a-spacing-top-medium"
                        style={{
                          display: "flex",
                          flexDirection: "row",
                          flexWrap: "wrap",
                      ...
                      >
                        {order.items.map((item) => (
                          <div
                            ...
                            className="a-fixed-right-grid-inner a-grid-vertical-align a-grid-top"
                            style={{ width: "auto" }}
                          >
                            <div className="a-fixed-right-grid-col a-col-left">
                              <div className="a-row">
                                <div className="a-fixed-left-grid a-spacing-none">
                                  ...
                                  >
                                    <div
                                      className="a-text-center a-fixed-left-grid-col a-col-left"
                                      style={{
                                        width: "100px",
                                        marginLeft: "-100px",
                                        float: "left",
                                    ...
                                    >
                                      <div className="item-view-left-col-inner">
                                        <img
                                          src={require(`../../public/static/${item.sku}`)}
